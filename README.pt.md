...
### [Conceitos](concepts/)
Teoria fundamental sobre Agentes, Ferramentas, Memória e Engenharia de Contexto.
*Por que um Agente é diferente de um Chatbot? Como gerenciar contexto?*
...
Contribuições são bem-vindas! Leia nossas diretrizes:
- [Guia de Contribuição (Português)](CONTRIBUTING.pt.md)
- [Contributing Guide (English)](CONTRIBUTING.md)

## Licença

MIT © [Knowledge Temple Contributors]
